...
# I did not write this function and claim no credit for it.
# It turns out determining whether an 'a' should be an 'a' or an 'an' or really difficult, so in the spirit of the internet,
# I found someone who had already implemented it. By the MIT license, I am alowed to use it in my own projects free of charge
